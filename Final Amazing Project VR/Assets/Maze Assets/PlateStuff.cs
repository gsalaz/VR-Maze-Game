...
public class PlateStuff : MonoBehaviour
{
    ...
    void OnEnable() {
        PatternSolve.ResetTime += Unpress;
    }
    ...
    void OnCollisionEnter(Collision other) {
        //Debug.Log("Touch");
        if (other.gameObject.tag == "Player" && !isPressed && puzzle.GetComponent<PatternSolve>().IsCorrect(id)) {
            SetPos(true);
        }
    }
}
