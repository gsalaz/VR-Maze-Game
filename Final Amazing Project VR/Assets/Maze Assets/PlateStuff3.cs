...
public class PlateStuff3 : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision other) {
        //Debug.Log("Touch");
        if (other.gameObject.tag == "Player" && !isPressed && puzzle.GetComponent<AnswerSolve>().IsCorrect(id)) {
            SetPos(true);
        }
    }
}
